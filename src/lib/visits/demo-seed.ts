...
const DEMO_VISITS: DemoVisit[] = [
  ...
  { venueIdx: 0, offset: -22, type: "in_person", status: "missed", reason: "Monthly check-in — never logged." },
  { venueIdx: 1, offset: -19, type: "phone", status: "missed", reason: "Promised call-back on the new range." },
  { venueIdx: 2, offset: -16, type: "in_person", status: "missed", reason: "Was meant to pop in with samples." },

  // ---- 3–4: learned ~28–30d rhythm, last visit well past due → Overdue
  { venueIdx: 3, offset: -91, type: "in_person", status: "completed", notes: "Quarterly range review." },
  { venueIdx: 3, offset: -63, type: "in_person", status: "completed", notes: "Dropped fresh pasta samples." },
  { venueIdx: 3, offset: -35, type: "in_person", status: "completed", notes: "Restock visit — happy with volumes." },
  { venueIdx: 4, offset: -105, type: "in_person", status: "completed", notes: "First tasting with the head chef." },
  { venueIdx: 4, offset: -75, type: "phone", status: "completed", notes: "Confirmed the standing order." },
  { venueIdx: 4, offset: -45, type: "in_person", status: "completed", notes: "Menu refresh chat, left price list." },

  // ---- 5–6: same rhythm, due right about now → Due soon
  { venueIdx: 5, offset: -87, type: "in_person", status: "completed", notes: "Kitchen walkthrough." },
  { venueIdx: 5, offset: -58, type: "in_person", status: "completed", notes: "Tasting — keen on the burrata." },
  { venueIdx: 5, offset: -29, type: "in_person", status: "completed", notes: "Regular visit, all good." },
  { venueIdx: 6, offset: -81, type: "phone", status: "completed", notes: "Reorder call." },
  { venueIdx: 6, offset: -54, type: "in_person", status: "completed", notes: "Delivered the new-season menu." },
  { venueIdx: 6, offset: -26, type: "in_person", status: "completed", notes: "Quick drop-in, chef happy." },

  // ---- 7–9: recently seen, but Power BI sales flags (overlay below)
  { venueIdx: 7, offset: -10, type: "in_person", status: "completed", notes: "Routine visit — didn't mention volumes." },
  { venueIdx: 8, offset: -12, type: "phone", status: "completed", notes: "Left a voicemail about reordering." },
  { venueIdx: 9, offset: -9, type: "in_person", status: "completed", notes: "Dropped samples of the truffle range." },

  // ---- 10–14: recent history so the grid's past weeks look lived-in
  { venueIdx: 10, offset: -13, type: "site_visit", status: "completed", notes: "Walked the kitchen, sorted cold storage." },
  { venueIdx: 11, offset: -6, type: "in_person", status: "completed", followUp: true, notes: "Tasting went well; follow up on the ravioli quote." },
  { venueIdx: 12, offset: -4, type: "in_person", status: "completed", notes: "Standing Friday drop-in." },
  { venueIdx: 13, offset: -2, type: "in_person", status: "completed", notes: "Delivered squid-ink linguine samples." },
  { venueIdx: 14, offset: -1, type: "phone", status: "completed", notes: "Quick check-in, reorder next week." },

  // ---- 15+: confirmed future bookings (never on suggestion venues)
  { venueIdx: 15, offset: 0, type: "in_person", status: "scheduled", reason: "Standing drop-in." },
  { venueIdx: 16, offset: 0, type: "phone", status: "scheduled", reason: "Chase the tortelloni quote." },
  { venueIdx: 17, offset: 1, type: "in_person", status: "scheduled", reason: "New product tasting." },
  { venueIdx: 18, offset: 2, type: "in_person", status: "scheduled", reason: "Quarterly review." },
  { venueIdx: 19, offset: 3, type: "phone", status: "scheduled", reason: "Confirm festive volumes." },
  { venueIdx: 20, offset: 4, type: "in_person", status: "scheduled", reason: "Sample drop." },
  { venueIdx: 21, offset: 6, type: "site_visit", status: "scheduled", reason: "Review cold storage." },
  { venueIdx: 22, offset: 7, type: "in_person", status: "scheduled", reason: "Weekly visit." },
  { venueIdx: 23, offset: 8, type: "phone", status: "scheduled", reason: "Review pricing." },
  { venueIdx: 24, offset: 9, type: "in_person", status: "scheduled", reason: "Reconnect visit." },
  { venueIdx: 25, offset: 11, type: "in_person", status: "scheduled", reason: "Menu refresh." },
  { venueIdx: 26, offset: 13, type: "in_person", status: "scheduled", reason: "Fortnightly visit." },
  { venueIdx: 27, offset: 14, type: "phone", status: "scheduled", reason: "Follow up on samples." },
  { venueIdx: 28, offset: 15, type: "in_person", status: "scheduled", reason: "Tasting session." },
  { venueIdx: 29, offset: 17, type: "in_person", status: "scheduled", reason: "Check stock levels." },
  { venueIdx: 30, offset: 20, type: "in_person", status: "scheduled", reason: "Monthly review." },
  { venueIdx: 31, offset: 22, type: "phone", status: "scheduled", reason: "Confirm order." },
  { venueIdx: 32, offset: 24, type: "in_person", status: "scheduled", reason: "New-opening follow-up." },
];
